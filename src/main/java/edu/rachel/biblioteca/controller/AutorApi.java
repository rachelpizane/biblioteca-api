...
public interface AutorApi {
    ...
    @Operation(
            summary = "Buscar livros de um autor",
            description = "Retorna uma lista de livros de um autor"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    public ResponseEntity<List<LivroResumoDTO>> buscarLivrosPorAutor(@PathVariable UUID id);
}
